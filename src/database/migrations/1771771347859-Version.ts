...
export class Version1771771347859 implements MigrationInterface {
    name = 'Version1771771347859'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "hand_gun" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "created_by" integer, "updated_by" integer, "deleted_by" integer, "isDiscounted" boolean NOT NULL DEFAULT false, "name" character varying NOT NULL, "variation" character varying, "description" character varying, "reference" character varying NOT NULL, "barrelLength" integer, "barrelSize" integer NOT NULL, "isThreadedBarrel" boolean NOT NULL DEFAULT false, "isAdjustableTrigger" boolean NOT NULL DEFAULT false, "adjustableTriggerMinWeight" integer, "adjustableTriggerMaxWeight" integer, "providedMagazineQuantity" integer NOT NULL DEFAULT '1', "isAdjustableFrontSight" boolean NOT NULL DEFAULT false, "isAdjustableBackSight" boolean NOT NULL DEFAULT false, "isOpticReady" boolean NOT NULL DEFAULT false, "isPicatinyRailSlop" boolean NOT NULL DEFAULT false, "decocking" boolean NOT NULL DEFAULT false, "isExternalHammer" boolean NOT NULL DEFAULT true, "categoryId" integer NOT NULL, "caliberId" integer NOT NULL, "factoryId" integer NOT NULL, "typeId" integer NOT NULL, "barrelTypeId" integer, "threadedSizeId" integer, "percussionTypeId" integer, "buttMaterialId" integer, "slideMaterialId" integer, "slideColorId" integer, "triggerTypeId" integer, "buttColorId" integer, "barrelColorId" integer, CONSTRAINT "UQ_583a4ca651ce9ea896376da02bd" UNIQUE ("name", "variation", "factoryId", "caliberId", "reference"), CONSTRAINT "PK_2d1ee46cef1360781b27e138e4f" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "client_order_item" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "object" character varying NOT NULL, "objectId" integer NOT NULL, "quantity" integer NOT NULL DEFAULT '0', "unitPriceHT" integer NOT NULL, "totalPriceHT" integer NOT NULL, "status" character varying NOT NULL DEFAULT 'IN_ORDER', "name" character varying NOT NULL, "totalPrice" integer NOT NULL, "comment" character varying NOT NULL, "to" jsonb NOT NULL, "orderId" integer, "categoryId" integer, CONSTRAINT "PK_89136e775fdb15550c2aac98d33" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "client_order" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "created_by" integer, "updated_by" integer, "deleted_by" integer, "totalPriceHt" integer NOT NULL, "vat" integer NOT NULL DEFAULT '20', "shippingCost" integer NOT NULL DEFAULT '0', "invoiceStatus" character varying NOT NULL DEFAULT 'IN_ORDER', "message" character varying NOT NULL, "totalPriceTTC" integer NOT NULL, "totalItems" integer NOT NULL, "cartValidity" TIMESTAMP NOT NULL, "shippingAddressId" integer, "paymentAddressId" integer, "orderedById" integer, CONSTRAINT "PK_df9613f771136dc7059b147a601" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "users" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "email" character varying NOT NULL, "password" character varying NOT NULL, "firstName" character varying NOT NULL, "lastName" character varying NOT NULL, "phone" character varying NOT NULL, "role" character varying NOT NULL DEFAULT 'USER', "costumerRole" character varying NOT NULL DEFAULT 'Sans licence', CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "optic_collar" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "created_by" integer, "updated_by" integer, "deleted_by" integer, "isDiscounted" boolean NOT NULL DEFAULT false, "diameter" integer NOT NULL, "height" integer NOT NULL, "reference" character varying NOT NULL, "name" character varying NOT NULL, "description" character varying NOT NULL, "factoryId" integer, "railSizeId" integer, CONSTRAINT "UQ_17fdef4059c6defaecb14125819" UNIQUE ("name", "factoryId", "height", "diameter"), CONSTRAINT "PK_ea65cd8dea1dbe4e200a72cfc88" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "riffle" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "created_by" integer, "updated_by" integer, "deleted_by" integer, "isDiscounted" boolean NOT NULL DEFAULT false, "name" character varying NOT NULL, "variation" character varying, "description" character varying, "reference" character varying NOT NULL, "barrelLength" integer, "barrelSize" integer NOT NULL, "isThreadedBarrel" boolean NOT NULL DEFAULT false, "isAdjustableTrigger" boolean NOT NULL DEFAULT false, "adjustableTriggerMinWeight" integer, "adjustableTriggerMaxWeight" integer, "providedMagazineQuantity" integer NOT NULL DEFAULT '1', "isAdjustableFrontSight" boolean NOT NULL DEFAULT false, "isAdjustableBackSight" boolean NOT NULL DEFAULT false, "isAdjustableButt" boolean NOT NULL, "isAdjustableBusk" boolean NOT NULL, "grenadierSlot" integer NOT NULL, "qcSlot" integer NOT NULL DEFAULT '0', "isMlockCompatibility" boolean NOT NULL DEFAULT false, "isOpenAim" boolean NOT NULL DEFAULT true, "categoryId" integer NOT NULL, "caliberId" integer NOT NULL, "factoryId" integer NOT NULL, "typeId" integer NOT NULL, "barrelTypeId" integer, "threadedSizeId" integer, "percussionTypeId" integer, "buttMaterialId" integer, "railSizeId" integer, "buttColorId" integer, "barrelColorId" integer, CONSTRAINT "UQ_d8c88bbff42471b5e5b4fb3fc45" UNIQUE ("name", "variation", "factoryId", "caliberId", "reference"), CONSTRAINT "PK_d7352a218cdba0a91f278eda09e" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "sound_noise_reducer" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "created_by" integer, "updated_by" integer, "deleted_by" integer, "isDiscounted" boolean NOT NULL DEFAULT false, "diameter" integer NOT NULL, "length" integer NOT NULL, "chicane" integer NOT NULL, "estimatedNoiseReduction" integer NOT NULL, "name" character varying NOT NULL, "description" character varying NOT NULL, "isCleanable" boolean NOT NULL DEFAULT false, "reference" character varying NOT NULL, "threadedSizeId" integer, "caliberId" integer, "factoryId" integer, CONSTRAINT "UQ_8a0d25f7fd2065831d873c82250" UNIQUE ("threadedSizeId", "factoryId", "name"), CONSTRAINT "PK_e029ae95ad66819d729f37fa6e3" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "ammunition" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "created_by" integer, "updated_by" integer, "deleted_by" integer, "isDiscounted" boolean NOT NULL DEFAULT false, "name" character varying NOT NULL, "description" character varying, "initialSpeed" integer NOT NULL, "packaging" integer NOT NULL, "reference" character varying NOT NULL, "categoryId" integer, "factoryId" integer, "caliberId" integer, "headTypeId" integer, "bodyTypeId" integer, "percussionTypeId" integer, CONSTRAINT "UQ_bdbf66a8e179ce54a305a7f9849" UNIQUE ("name", "factoryId", "packaging"), CONSTRAINT "PK_f0b206270265705a6754eb92807" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "optic_click" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "name" character varying NOT NULL, "opticUnitId" integer, CONSTRAINT "PK_b17032e75c95e1ca3cd7a8214f6" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "optic" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "created_by" integer, "updated_by" integer, "deleted_by" integer, "isDiscounted" boolean NOT NULL DEFAULT false, "name" character varying NOT NULL, "minZoom" integer NOT NULL, "maxZoom" integer NOT NULL, "description" character varying NOT NULL, "bodyDiameter" integer NOT NULL, "lensDiameter" integer NOT NULL, "isParallax" boolean NOT NULL DEFAULT false, "maxElevation" integer NOT NULL, "maxDrift" integer NOT NULL, "minParallax" integer NOT NULL, "maxParallax" integer NOT NULL, "length" integer NOT NULL, "eyeRelief" integer NOT NULL, "isCollarsProvided" boolean NOT NULL, "reference" character varying NOT NULL, "factoryId" integer, "focalPlaneId" integer, "opticUnitId" integer, "clickValueId" integer, "typeId" integer, "providedOpticCollarSizeId" integer, CONSTRAINT "UQ_f547e8ea26fd991cc730aaeac4f" UNIQUE ("name", "factoryId", "minZoom", "maxZoom", "bodyDiameter", "lensDiameter"), CONSTRAINT "PK_89c5d3ed25bd01433c9159ba621" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "weapon_magazine" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "created_by" integer, "updated_by" integer, "deleted_by" integer, "isDiscounted" boolean NOT NULL DEFAULT false, "capacity" integer NOT NULL, "length" integer NOT NULL, "height" integer NOT NULL, "width" integer NOT NULL, "reference" character varying NOT NULL, "description" character varying, "categoryId" integer, "bodyId" integer, "factoryId" integer, "caliberId" integer, "forWeaponTypeId" integer, CONSTRAINT "UQ_eb747bb912f05ec358bf3c3fbaf" UNIQUE ("factoryId", "categoryId", "bodyId", "capacity", "caliberId"), CONSTRAINT "PK_4b3911fc7c13e3633b47419f14f" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "price_history" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "created_by" integer, "updated_by" integer, "deleted_by" integer, "supplierPrice" double precision NOT NULL, "recommendedSalePrice" double precision, "currentSalePrice" double precision, "precentOfDiscount" double precision, "discountedPrice" double precision, "isDiscounted" boolean NOT NULL DEFAULT false, "objectId" integer NOT NULL, "object" character varying NOT NULL, "supplierId" integer, CONSTRAINT "PK_e41e25472373d4b574b153229e9" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "item_invoice_supplier" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "object" character varying NOT NULL, "objectId" integer NOT NULL, "quantity" integer NOT NULL DEFAULT '0', "supplierPriceHT" integer NOT NULL, "totalPriceHT" integer NOT NULL, "accountHT" integer NOT NULL, "internalInvoiceReference" character varying NOT NULL, "comment" character varying, "description" character varying, "status" character varying NOT NULL DEFAULT 'IN_ORDER', "shipmentNumber" character varying, "invoiceId" integer, CONSTRAINT "PK_c41c2b56f1baa74b50f807b8e0a" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "invoice_supplier" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "created_by" integer, "updated_by" integer, "deleted_by" integer, "totalPriceHt" integer NOT NULL, "internalInvoiceReference" character varying NOT NULL, "comment" character varying, "totalInvoiceItems" integer NOT NULL, "dueDate" TIMESTAMP NOT NULL, "totalAccountHT" integer NOT NULL DEFAULT '0', "vat" integer NOT NULL DEFAULT '20', "shippingCost" integer NOT NULL DEFAULT '0', "invoiceSupplierReference" character varying, "invoiceStatus" character varying NOT NULL DEFAULT 'IN_ORDER', "supplierId" integer, CONSTRAINT "UQ_9fa37f6d45eff4f9d0aa3f33ca3" UNIQUE ("totalPriceHt", "supplierId", "totalAccountHT", "totalInvoiceItems", "shippingCost"), CONSTRAINT "PK_8d86c7034ecfb05a14e541b5b67" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "stock_history" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "created_by" integer, "updated_by" integer, "deleted_by" integer, "movement" character varying NOT NULL, "movementQuantity" integer NOT NULL, "previousQuantity" integer NOT NULL, "newQuantity" integer NOT NULL, "reason" character varying, "stockId" integer, CONSTRAINT "PK_16924caa54ac1fa49162ea3afca" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "hand_gun" ADD CONSTRAINT "FK_5a683229905b5ba42ef4a1981a1" FOREIGN KEY ("created_by") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "hand_gun" ADD CONSTRAINT "FK_1c5a609ac2cc4bec2f833147967" FOREIGN KEY ("updated_by") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "hand_gun" ADD CONSTRAINT "FK_44c7c65c7a95efb61c3733348b3" FOREIGN KEY ("deleted_by") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "client_order_item" ADD CONSTRAINT "FK_e7e98af838c9c2377fe93a00c07" FOREIGN KEY ("categoryId") REFERENCES "legislation_category"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "client_order" ADD CONSTRAINT "FK_d0bd617b53b2a954e8443f81098" FOREIGN KEY ("shippingAddressId") REFERENCES "address"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "client_order" ADD CONSTRAINT "FK_e49bab4a23b36520883d8e6b91a" FOREIGN KEY ("paymentAddressId") REFERENCES "address"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "client_order" ADD CONSTRAINT "FK_cbbaa92968d7bf4afc4728b2244" FOREIGN KEY ("orderedById") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "client_order" ADD CONSTRAINT "FK_8e88f4dcd69cf1b5daee89f19ca" FOREIGN KEY ("created_by") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "client_order" ADD CONSTRAINT "FK_d1df22bc5dd1778a8ce9b0608d3" FOREIGN KEY ("updated_by") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "client_order" ADD CONSTRAINT "FK_cdcbd6e419c735cac0ecfe34e53" FOREIGN KEY ("deleted_by") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "optic_collar" ADD CONSTRAINT "FK_26bfe722414fe3c4a0273f9cdc7" FOREIGN KEY ("created_by") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "optic_collar" ADD CONSTRAINT "FK_377f91c9214ea7490761faf8073" FOREIGN KEY ("updated_by") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "optic_collar" ADD CONSTRAINT "FK_fda1d3dc55d4603f13833153d76" FOREIGN KEY ("deleted_by") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "riffle" ADD CONSTRAINT "FK_877b67d28cb085b49a62aad767f" FOREIGN KEY ("created_by") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "riffle" ADD CONSTRAINT "FK_0c67b33bce5ac22b63596033e51" FOREIGN KEY ("updated_by") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "riffle" ADD CONSTRAINT "FK_de1e119d1902090aed3ec2383b9" FOREIGN KEY ("deleted_by") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "sound_noise_reducer" ADD CONSTRAINT "FK_d591cca19916e1d4da32b62eb3b" FOREIGN KEY ("created_by") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "sound_noise_reducer" ADD CONSTRAINT "FK_685b4d2700c99dc1fe10c4ff46c" FOREIGN KEY ("updated_by") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "sound_noise_reducer" ADD CONSTRAINT "FK_711227c402f86e3dc6b8d6d7405" FOREIGN KEY ("deleted_by") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "ammunition" ADD CONSTRAINT "FK_c21c9f0fc71f1b99bdf7f75bc1b" FOREIGN KEY ("created_by") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "ammunition" ADD CONSTRAINT "FK_a5faf951fdeb90c1426af7609ec" FOREIGN KEY ("updated_by") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "ammunition" ADD CONSTRAINT "FK_9a5280cd676d5e0a4c8b375f6f2" FOREIGN KEY ("deleted_by") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "optic_click" ADD CONSTRAINT "FK_9d55d63e93be94e98ef515bfc38" FOREIGN KEY ("opticUnitId") REFERENCES "optic_unit"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "optic" ADD CONSTRAINT "FK_4d757e94f8902a2dfe407d51fa6" FOREIGN KEY ("clickValueId") REFERENCES "optic_click"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "optic" ADD CONSTRAINT "FK_48641b8d2ab0490cec8af5cc79f" FOREIGN KEY ("created_by") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "optic" ADD CONSTRAINT "FK_4304fd8a3fbb35bd21537272336" FOREIGN KEY ("updated_by") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "optic" ADD CONSTRAINT "FK_db7c97dbb36329e501203667f85" FOREIGN KEY ("deleted_by") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "weapon_magazine" ADD CONSTRAINT "FK_f0cee0c78a6efd60cb79998b0a1" FOREIGN KEY ("categoryId") REFERENCES "legislation_category"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "weapon_magazine" ADD CONSTRAINT "FK_22f2e6ed6d0195266b46e94afc2" FOREIGN KEY ("forWeaponTypeId") REFERENCES "weapon_type"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "stock_history" ADD CONSTRAINT "FK_b557ec898884f70b121947cd214" FOREIGN KEY ("created_by") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "stock_history" DROP CONSTRAINT "FK_b557ec898884f70b121947cd214"`);
        ...
        await queryRunner.query(`ALTER TABLE "weapon_magazine" DROP CONSTRAINT "FK_22f2e6ed6d0195266b46e94afc2"`);
        ...
        await queryRunner.query(`ALTER TABLE "weapon_magazine" DROP CONSTRAINT "FK_f0cee0c78a6efd60cb79998b0a1"`);
        await queryRunner.query(`ALTER TABLE "factory" DROP CONSTRAINT "FK_a47c8e3d455a3ad8d7a1695b9c7"`);
        await queryRunner.query(`ALTER TABLE "optic" DROP CONSTRAINT "FK_db7c97dbb36329e501203667f85"`);
        await queryRunner.query(`ALTER TABLE "optic" DROP CONSTRAINT "FK_4304fd8a3fbb35bd21537272336"`);
        await queryRunner.query(`ALTER TABLE "optic" DROP CONSTRAINT "FK_48641b8d2ab0490cec8af5cc79f"`);
        ...
        await queryRunner.query(`ALTER TABLE "optic" DROP CONSTRAINT "FK_4d757e94f8902a2dfe407d51fa6"`);
        ...
        await queryRunner.query(`ALTER TABLE "optic_click" DROP CONSTRAINT "FK_9d55d63e93be94e98ef515bfc38"`);
        await queryRunner.query(`ALTER TABLE "ammunition" DROP CONSTRAINT "FK_9a5280cd676d5e0a4c8b375f6f2"`);
        await queryRunner.query(`ALTER TABLE "ammunition" DROP CONSTRAINT "FK_a5faf951fdeb90c1426af7609ec"`);
        await queryRunner.query(`ALTER TABLE "ammunition" DROP CONSTRAINT "FK_c21c9f0fc71f1b99bdf7f75bc1b"`);
        ...
        await queryRunner.query(`ALTER TABLE "sound_noise_reducer" DROP CONSTRAINT "FK_711227c402f86e3dc6b8d6d7405"`);
        await queryRunner.query(`ALTER TABLE "sound_noise_reducer" DROP CONSTRAINT "FK_685b4d2700c99dc1fe10c4ff46c"`);
        await queryRunner.query(`ALTER TABLE "sound_noise_reducer" DROP CONSTRAINT "FK_d591cca19916e1d4da32b62eb3b"`);
        ...
        await queryRunner.query(`ALTER TABLE "riffle" DROP CONSTRAINT "FK_de1e119d1902090aed3ec2383b9"`);
        await queryRunner.query(`ALTER TABLE "riffle" DROP CONSTRAINT "FK_0c67b33bce5ac22b63596033e51"`);
        await queryRunner.query(`ALTER TABLE "riffle" DROP CONSTRAINT "FK_877b67d28cb085b49a62aad767f"`);
        ...
        await queryRunner.query(`ALTER TABLE "optic_collar" DROP CONSTRAINT "FK_fda1d3dc55d4603f13833153d76"`);
        await queryRunner.query(`ALTER TABLE "optic_collar" DROP CONSTRAINT "FK_377f91c9214ea7490761faf8073"`);
        await queryRunner.query(`ALTER TABLE "optic_collar" DROP CONSTRAINT "FK_26bfe722414fe3c4a0273f9cdc7"`);
        ...
        await queryRunner.query(`ALTER TABLE "client_order" DROP CONSTRAINT "FK_cdcbd6e419c735cac0ecfe34e53"`);
        await queryRunner.query(`ALTER TABLE "client_order" DROP CONSTRAINT "FK_d1df22bc5dd1778a8ce9b0608d3"`);
        await queryRunner.query(`ALTER TABLE "client_order" DROP CONSTRAINT "FK_8e88f4dcd69cf1b5daee89f19ca"`);
        await queryRunner.query(`ALTER TABLE "client_order" DROP CONSTRAINT "FK_cbbaa92968d7bf4afc4728b2244"`);
        await queryRunner.query(`ALTER TABLE "client_order" DROP CONSTRAINT "FK_e49bab4a23b36520883d8e6b91a"`);
        await queryRunner.query(`ALTER TABLE "client_order" DROP CONSTRAINT "FK_d0bd617b53b2a954e8443f81098"`);
        await queryRunner.query(`ALTER TABLE "client_order_item" DROP CONSTRAINT "FK_e7e98af838c9c2377fe93a00c07"`);
        await queryRunner.query(`ALTER TABLE "client_order_item" DROP CONSTRAINT "FK_3715ce8b3b31b9541c73964d6dc"`);
        await queryRunner.query(`ALTER TABLE "hand_gun" DROP CONSTRAINT "FK_44c7c65c7a95efb61c3733348b3"`);
        await queryRunner.query(`ALTER TABLE "hand_gun" DROP CONSTRAINT "FK_1c5a609ac2cc4bec2f833147967"`);
        await queryRunner.query(`ALTER TABLE "hand_gun" DROP CONSTRAINT "FK_5a683229905b5ba42ef4a1981a1"`);
        ...
        await queryRunner.query(`DROP TABLE "client_order_item"`);
