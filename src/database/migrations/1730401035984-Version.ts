...
export class Version1730401035984 implements MigrationInterface {
    name = 'Version1730401035984'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "weapon_magazine" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "capacity" integer NOT NULL, "body" character varying NOT NULL, "length" integer NOT NULL, "height" integer NOT NULL, "width" integer NOT NULL, "reference" character varying NOT NULL, "factoryId" integer, CONSTRAINT "PK_4b3911fc7c13e3633b47419f14f" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "optic" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "name" character varying NOT NULL, "minZoom" integer NOT NULL, "description" character varying NOT NULL, "maxZoom" integer NOT NULL, "bodyDiameter" integer NOT NULL, "lensDiameter" integer NOT NULL, "focalPlane" character varying NOT NULL DEFAULT 'Second plan focal', "isParallax" boolean NOT NULL DEFAULT false, "maxElevation" integer NOT NULL, "minElevation" integer NOT NULL, "opticUnit" character varying NOT NULL DEFAULT 'MOA', "valueOfOneClick" integer NOT NULL, "minParallax" integer NOT NULL, "maxParallax" integer NOT NULL, "factoryId" integer, CONSTRAINT "PK_89c5d3ed25bd01433c9159ba621" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "ammunition" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "name" character varying NOT NULL, "description" character varying, "category" character varying NOT NULL, "initialSpeed" integer NOT NULL, "percussionType" character varying NOT NULL, "packaging" integer NOT NULL, "reference" character varying NOT NULL, "factoryId" integer, "caliberId" integer, "headTypeId" integer, "bodyTypeId" integer, CONSTRAINT "UQ_bdbf66a8e179ce54a305a7f9849" UNIQUE ("name", "factoryId", "packaging"), CONSTRAINT "PK_f0b206270265705a6754eb92807" PRIMARY KEY ("id"))`);
