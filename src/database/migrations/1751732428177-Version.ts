...
export class Version1751732428177 implements MigrationInterface {
    name = 'Version1751732428177'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "weapon_magazine" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "capacity" integer NOT NULL, "length" integer NOT NULL, "height" integer NOT NULL, "width" integer NOT NULL, "reference" character varying NOT NULL, "description" character varying, "categoryId" integer, "bodyId" integer, "factoryId" integer, "caliberId" integer, "forWeaponTypeId" integer, CONSTRAINT "PK_4b3911fc7c13e3633b47419f14f" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "optic" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "name" character varying NOT NULL, "minZoom" integer NOT NULL, "maxZoom" integer NOT NULL, "description" character varying NOT NULL, "bodyDiameter" integer NOT NULL, "lensDiameter" integer NOT NULL, "isParallax" boolean NOT NULL DEFAULT false, "maxElevation" integer NOT NULL, "maxDrift" integer NOT NULL, "valueOfOneClick" integer NOT NULL, "minParallax" integer NOT NULL, "maxParallax" integer NOT NULL, "length" integer NOT NULL, "eyeRelief" integer NOT NULL, "isCollarsProvided" boolean NOT NULL, "reference" character varying NOT NULL, "factoryId" integer, "focalPlaneId" integer, "opticUnitId" integer, "typeId" integer, CONSTRAINT "PK_89c5d3ed25bd01433c9159ba621" PRIMARY KEY ("id"))`);
