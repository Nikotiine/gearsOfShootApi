...
export class Version1764614352325 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "ammunition" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "name" character varying NOT NULL, "description" character varying, "initialSpeed" integer NOT NULL, "packaging" integer NOT NULL, "reference" character varying NOT NULL, "created_by" integer, "updated_by" integer, "deleted_by" integer, "categoryId" integer, "factoryId" integer, "caliberId" integer, "headTypeId" integer, "bodyTypeId" integer, "percussionTypeId" integer, CONSTRAINT "UQ_bdbf66a8e179ce54a305a7f9849" UNIQUE ("name", "factoryId", "packaging"), CONSTRAINT "PK_f0b206270265705a6754eb92807" PRIMARY KEY ("id"))`);
