...
export class Version1732718472886 implements MigrationInterface {
    name = 'Version1732718472886'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "optic_ready_plate" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "name" character varying NOT NULL, "description" character varying, "factoryId" integer, CONSTRAINT "PK_1b97130486dd3f9058c62675c49" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "weapon" ADD CONSTRAINT "FK_d22ae071e6d4c60477285c5fa3f" FOREIGN KEY ("buttId") REFERENCES "material"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
