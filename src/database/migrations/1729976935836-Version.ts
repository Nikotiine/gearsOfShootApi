...
export class Version1729976935836 implements MigrationInterface {
    name = 'Version1729976935836'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "factory" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "isActive" boolean NOT NULL DEFAULT true, "name" character varying NOT NULL, "ref" character varying NOT NULL, "description" character varying, "factoryType" character varying NOT NULL, CONSTRAINT "UQ_afc714bfab2783ce224d0ff41d9" UNIQUE ("name", "factoryType"), CONSTRAINT "PK_1372e5a7d114a3fa80736ba66bb" PRIMARY KEY ("id"))`);
